...
class PostsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Post::create(array(
            ...
            'user_id'   => rand(0,20),
            'title'     => 'Wikipedia Cat',
            'body'      => 'The domestic cat (Felis catus or Felis silvestris catus) is a small, usually furry, domesticated, and carnivorous mammal. It is often called the housecat when kept as an indoor pet, or simply the cat when there is no need to distinguish it from other felids and felines. Cats are often valued by humans for companionship and their ability to hunt vermin and household pests.',
            'type'      => 'text',
        ));
        Post::create(array(
            'id'        => 4,
        ...
        Post::create(array(
            ...
            'body'      => 'Animals are multicellular, eukaryotic organisms of the kingdom Animalia or Metazoa. Their body plan eventually becomes fixed as they develop, although some undergo a process of metamorphosis later on in their lives. Most animals are motile, meaning they can move spontaneously and independently. All animals must ingest other organisms or their products for sustenance (see Heterotroph).',
            'type'      => 'text',
        ));
        Post::create(array(
            'id'        => 6,
        ...
        Post::create(array(
            ...
            'body'      => 'int rand() {  random_seed = random_seed * 1103515245 +12345; <br /> return (unsigned int)(random_seed / 65536) % 32768; }',
            'type'      => 'text',
        ));
    }
